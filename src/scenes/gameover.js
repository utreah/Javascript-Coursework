...
export default function gameOver(){
    ...
    if(kaplay_canvas.getData("best-score") == null)
        ...
        kaplay_canvas.add([kaplay_canvas.text("SCORE: " + kaplay_canvas.getData("session-score")), { size: 0 , font: "slkscr"}, kaplay_canvas.pos(0, 0)]);
        kaplay_canvas.add([kaplay_canvas.text("BEST SCORE: " + loggedUser.bestScore), { size: 0 , font: "slkscr"}, kaplay_canvas.pos(0, 50)]);
